...
export const BLOG_ARTICLES: BlogArticle[] = [
  {
    ...
    excerpt: {
      fr: "Un week-end ressourçant dans les montagnes, riche en partage et en communion fraternelle.",
      pt: "Um fim de semana revigorante nas montanhas, rico em partilha e comunhão fraternal.",
      en: "A refreshing weekend in the mountains, rich in sharing and fellowship.",
    },
    content: {
