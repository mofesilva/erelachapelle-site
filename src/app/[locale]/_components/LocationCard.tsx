...
export function LocationCard({
  ...
  return (
    <PeekRectangle color="gold" position="top-right">
      <div className="group relative overflow-hidden bg-white shadow-[0_8px_40px_rgba(0,0,0,0.08)] transition-all duration-500 hover:shadow-[0_16px_60px_rgba(106,13,30,0.15)] hover:-translate-y-1">
        ...
        <div className="p-6">
          ...
          <div className="mt-3 flex items-center gap-3">
            ...
            <p className="font-semibold text-rich-mahogany">{schedule}</p>
          </div>

          {/* Decorative bottom accent */}
          <div className="mt-5 h-0.5 w-12 bg-gradient-to-r from-toffee-brown to-powder-petal" />
        </div>
      </div>
    </PeekRectangle>
  );
