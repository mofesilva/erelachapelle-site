      ...
      <div className="relative flex min-h-150 items-end md:min-h-175">
        <div className="w-full pb-16 pt-24 md:pb-24">
          <div className="mx-auto max-w-6xl px-6 md:px-10">
            ...
            {/* Church name */}
            <h2 className="mt-5 max-w-2xl font-serif text-4xl font-bold leading-[1.1] text-parchment md:text-6xl lg:text-7xl">
              {t("churchName")}
            </h2>
            ...
            <div className="mt-12 flex flex-col gap-10 sm:flex-row sm:items-start sm:gap-0">
              ...
              <div className="flex flex-col items-start sm:pr-10">
                ...
                <h6 className="mt-3 text-[11px] font-bold uppercase tracking-[0.2em] text-parchment/40">
                  {t("addressLabel")}
                </h6>
              ...
              <div className="flex flex-col items-start sm:px-10">
                ...
                <p className="mt-2 text-xl font-semibold text-parchment">
