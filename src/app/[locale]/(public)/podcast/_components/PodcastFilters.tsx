...
/** Mesmo padrão do ArticleFilters em /blog: só busca por texto, com debounce. */
export function PodcastFilters() {
  ...
  useEffect(() => {
    ...
    const timeout = setTimeout(() => {
      ...
      router.push(`/${locale}/podcast?${params.toString()}`, { scroll: false });
    }, 400);
    ...
    <div className="space-y-3">
      ...
      {activeQuery && (
        <button
          onClick={() => {
            setQuery("");
            router.push(`/${locale}/podcast`, { scroll: false });
          }}
